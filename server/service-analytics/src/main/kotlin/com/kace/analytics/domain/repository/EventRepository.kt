...
interface EventRepository {
     ...
     * 删除指定时间之前的事件
     */
    suspend fun deleteOlderThan(time: Instant): Int
     ...
     * 获取热门事件
     */
    suspend fun getTopEvents(filter: EventFilter, limit: Int): List<Map<String, Any>>
    
    /**
     * 获取事件趋势
     */
    suspend fun getTrend(filter: EventFilter, interval: String): List<Map<String, Any>>
} 