...
interface OrganizationService {
     ...
     * @return 创建的组织对象
     */
    suspend fun createOrganization(organization: Organization, ownerId: String): Organization
     ...
     * @return 是否更新成功
     */
    suspend fun updateOrganizationStatus(id: String, status: OrganizationStatus): Boolean
     ...
     * @return 组织成员分页对象
     */
    suspend fun getOrganizationMembers(organizationId: String, page: Int, size: Int): PageDto<OrganizationMember>
     ...
     * @return 添加的组织成员对象
     */
    suspend fun addOrganizationMember(organizationId: String, userId: String, role: OrganizationRole): OrganizationMember
     ...
     * @return 是否移除成功
     */
    suspend fun removeOrganizationMember(id: String): Boolean
     ...
     * @return 是否是成员
     */
    suspend fun isOrganizationMember(organizationId: String, userId: String): Boolean
     ...
     * @return 是否有权限
     */
    suspend fun hasOrganizationPermission(organizationId: String, userId: String, requiredRole: OrganizationRole): Boolean
} 